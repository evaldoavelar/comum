...
type
  ...
  ISQLWhere = interface(ISQLClause)
    ...
    function Equal(pNamedParam: string): ISQLWhere; overload;
    ...
    function NotIn(pValue: string): ISQLWhere; overload;
  ...
  ISQLUpdate = interface(ISQLStatement)
    ...
    function ColumnSetValue(const pColumn: string; const pNamedParam: string): ISQLUpdate; overload;
  ...
  ISQLInsert = interface(ISQLStatement)
    ...
    function ColumnValue(const pColumn: string; pNamedParam: string): ISQLInsert; overload;
...
begin
  ...
  case FType of
    ...
    jtFull:
      Result := ' Full outer Join ' + FTable.Name + ' On ';
  end;
...
function TSQLWhere.Equal(pNamedParam: string): ISQLWhere;
var
  vValue: ISQLValue;
begin
  vValue := TSQLValue.Create(pNamedParam);
  vValue.Expression.IsColumn;
...
function TSQLWhere.NotIn(pValue: string): ISQLWhere;
begin
  Criterias.Add(
    TSQLCriteria.Create(FColumn + ' not in ( ' + pValue + ')', FConnector)
    );
  Result := Self;
end;
...
function TSQLUpdate.ColumnSetValue(const pColumn, pNamedParam: string): ISQLUpdate;
var
  vValue: ISQLValue;
begin
  vValue := TSQLValue.Create(pNamedParam);
  ...
  Result := ColumnSetValue(pColumn, vValue);
end;
...
function TSQLInsert.ColumnValue(const pColumn: string; pNamedParam: string): ISQLInsert;
var
  vValue: ISQLValue;
begin
  vValue := TSQLValue.Create(pNamedParam);
  ...
  Result := ColumnValue(pColumn, vValue);
end;
